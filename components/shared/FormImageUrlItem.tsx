      ...
      <div className="flex items-center pt-4">
        <div className="mr-8 w-[80px] h-[80px] relative">
          {imageUrl.length === 0 ? <div className="w-full h-full border-2 border-dashed rounded-[4px] border-[#d9e1ec]" /> :
            <div className="logoWrapper h-full"><img src={imageUrl} alt="logo" className="w-full h-full" /><XCircle color="#020617" className="absolute -top-3 -right-3 cursor-pointer" onClick={(e) => setImageUrl('')} /></div>}
        </div>
