...
export default async function Dashboard() {
  ...
  return (
    <section className="sm:mt-20 mt-24">
      <div className="mt-6 flex justify-between items-center sm:px-2">
        <div>
          <h3 className="font-bold">Manage side-projects</h3>
          <p className="text-sm">Create and manage side-projects.</p>
        </div>
        <Button asChild className="text-[12px] h-[35px] sm:text-sm md:h-10"><Link href="/dashboard/admin/add">Add Project</Link></Button>
      </div>
